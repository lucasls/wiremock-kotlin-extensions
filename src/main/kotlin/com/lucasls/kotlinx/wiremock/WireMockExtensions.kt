...
inline fun verify(block: () -> RequestPatternBuilder) =
    WireMock.verify(block())

inline fun verify(count: Int, block: () -> RequestPatternBuilder) =
    WireMock.verify(count, block())

inline fun verify(
    countMatchingStrategy: CountMatchingStrategy?,
    block: () -> RequestPatternBuilder
) = WireMock.verify(countMatchingStrategy, block())

inline fun findAll(block: () -> RequestPatternBuilder): List<LoggedRequest> =
    WireMock.findAll(block())

inline fun removeServeEvents(block: () -> RequestPatternBuilder): List<ServeEvent> =
    WireMock.removeServeEvents(block())

inline fun getRequestedFor(urlPattern: UrlPattern, block: RequestPatternBuilder.() -> Unit): RequestPatternBuilder =
    WireMock.getRequestedFor(urlPattern).apply(block)

inline fun postRequestedFor(urlPattern: UrlPattern, block: RequestPatternBuilder.() -> Unit): RequestPatternBuilder =
    WireMock.postRequestedFor(urlPattern).apply(block)

inline fun putRequestedFor(urlPattern: UrlPattern, block: RequestPatternBuilder.() -> Unit): RequestPatternBuilder =
    WireMock.putRequestedFor(urlPattern).apply(block)

inline fun deleteRequestedFor(urlPattern: UrlPattern, block: RequestPatternBuilder.() -> Unit): RequestPatternBuilder =
    WireMock.deleteRequestedFor(urlPattern).apply(block)

inline fun patchRequestedFor(urlPattern: UrlPattern, block: RequestPatternBuilder.() -> Unit): RequestPatternBuilder =
    WireMock.patchRequestedFor(urlPattern).apply(block)

inline fun headRequestedFor(urlPattern: UrlPattern, block: RequestPatternBuilder.() -> Unit): RequestPatternBuilder =
    WireMock.headRequestedFor(urlPattern).apply(block)

inline fun optionsRequestedFor(urlPattern: UrlPattern, block: RequestPatternBuilder.() -> Unit):
        RequestPatternBuilder =
    WireMock.optionsRequestedFor(urlPattern).apply(block)

inline fun traceRequestedFor(urlPattern: UrlPattern, block: RequestPatternBuilder.() -> Unit): RequestPatternBuilder =
    WireMock.traceRequestedFor(urlPattern).apply(block)

inline fun anyRequestedFor(urlPattern: UrlPattern, block: RequestPatternBuilder.() -> Unit): RequestPatternBuilder =
...
): RequestPatternBuilder = WireMock.requestMadeFor(customMatcherName, parameters).apply(block)

inline fun requestMadeFor(
    requestMatcher: ValueMatcher<Request>, block: RequestPatternBuilder.() -> Unit
): RequestPatternBuilder = WireMock.requestMadeFor(requestMatcher).apply(block)

inline fun recordSpec(block: RecordSpecBuilder.() -> Unit): RecordSpecBuilder =
    WireMock.recordSpec().apply(block)

inline fun importStubs(block: () -> StubImportBuilder) =
    WireMock.importStubs(block())
